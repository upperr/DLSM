...
class Optimizer(object):
    def __init__(self, labels, model, epoch, num_nodes, features, pos_weight, norm, edges_for_loss, norm_feats, pos_weight_feats, node_labels = None, node_labels_mask = None, start_semisup=1.):
