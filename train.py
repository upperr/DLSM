...
# Train model
    ...
    np.savez(qual_file, theta = theta_save, theta_decoder = theta_decoder, posterior_theta_param = posterior_theta_param_save, roc_score = roc_score, ap_score = ap_score, auc_pr = auc_pr, reconstruction = reconstructions)
